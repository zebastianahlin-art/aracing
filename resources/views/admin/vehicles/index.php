...
<section class="card">
  ...
  <table class="table">
    <thead><tr><th>ID</th><th>Make / modell</th><th>Generation</th><th>Motor</th><th>Årsintervall</th><th>Aktiv</th><th>Sort</th><th></th></tr></thead>
    <tbody>
    <?php foreach ($vehicles as $vehicle): ?>
      <tr>
        ...
        <td><?= htmlspecialchars((string) ($vehicle['generation'] ?? '-'), ENT_QUOTES, 'UTF-8') ?></td>
        <td><?= htmlspecialchars((string) ($vehicle['engine'] ?? '-'), ENT_QUOTES, 'UTF-8') ?></td>
