...
final class AiPricingInsightAdminController
{
    public function __construct(
        private readonly ViewFactory $views,
        private readonly AiPricingInsightService $insights,
    ...
    public function index(): Response
    {
        ...
        return new Response($this->views->render('admin.ai_pricing_insights', [
            'payload' => $payload,
