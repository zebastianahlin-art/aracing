...
final class CheckoutService
{
    ...
    public function normalize(array $input): array
    {
        ...
        return [
            ...
            'company_name' => $this->nullable($input['company_name'] ?? null),
            'company_registration_number' => $this->nullable($input['company_registration_number'] ?? null),
            'vat_number' => $this->nullable($input['vat_number'] ?? null),
    ...
    public function buildDefaultsForCustomer(?array $customer): array
    {
        ...
        return [
            ...
            'company_registration_number' => trim((string) ($customer['company_registration_number'] ?? '')),
