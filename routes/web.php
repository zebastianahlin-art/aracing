...
$aiProductEnrichmentService = new AiProductEnrichmentService(
    $productService,
...
$aiProductLocalizationService = new AiProductLocalizationService(
    $productService,
    new AiProductEnrichmentSuggestionRepository($app['pdo']),
    new AiProductImportDraftRepository($app['pdo']),
    $app['config']
...
$aiInventoryInsightService = new AiInventoryInsightService(new AiInventoryInsightRepository($app['pdo']));
$aiInventoryInsightAdmin = new AiInventoryInsightAdminController(
    $app['view'],
    $aiInventoryInsightService,
    $brandService,
    $categoryService
);
$aiPricingInsightService = new AiPricingInsightService(new AiPricingInsightRepository($app['pdo']));
$aiPricingInsightAdmin = new AiPricingInsightAdminController(
    $app['view'],
    $aiPricingInsightService,
    $brandService,
    $categoryService
);
...
$aiAssortmentGapInsightService = new AiAssortmentGapInsightService(
    new AiAssortmentGapInsightRepository($app['pdo']),
    new AiSearchInsightService($searchQueryLogRepository, $searchQuerySuggestionRepository, $searchQueryAliasRepository, $catalogRepository),
    $supplierMonitoringService,
    $fitmentGapService
);
$aiAssortmentGapInsightAdmin = new AiAssortmentGapInsightAdminController($app['view'], $aiAssortmentGapInsightService);
$aiDemandSignalInsightService = new AiDemandSignalInsightService(new AiDemandSignalInsightRepository($app['pdo']));
$aiDemandSignalInsightAdmin = new AiDemandSignalInsightAdminController(
    $app['view'],
    $aiDemandSignalInsightService,
    $brandService,
    $categoryService
);
...
$compareController = new CompareController($app['view'], $cmsPageService, $seoService, $compareService);
...
$app['router']->get('/account/vehicles', [$savedVehicleController, 'index']);
$app['router']->post('/account/vehicles/primary', [$savedVehicleController, 'setPrimary']);
$app['router']->post('/account/vehicles/use', [$savedVehicleController, 'useVehicle']);
$app['router']->post('/account/vehicles/remove', [$savedVehicleController, 'remove']);
...
$app['router']->get('/admin/ai-pricing-insights', [$aiPricingInsightAdmin, 'index']);
...
$app['router']->post('/admin/products/{id}/ai-enrichment-suggestions', [$productAdmin, 'createEnrichmentSuggestion']);
$app['router']->post('/admin/products/{id}/ai-enrichment-suggestions/{suggestionId}/apply', [$productAdmin, 'applyEnrichmentSuggestion']);
$app['router']->post('/admin/products/{id}/ai-enrichment-suggestions/{suggestionId}/reject', [$productAdmin, 'rejectEnrichmentSuggestion']);
...
$app['router']->post('/admin/products/{id}/ai-localization-suggestions', [$productAdmin, 'createLocalizationSuggestion']);
$app['router']->post('/admin/products/{id}/ai-localization-suggestions/{suggestionId}/apply', [$productAdmin, 'applyLocalizationSuggestion']);
$app['router']->post('/admin/products/{id}/ai-localization-suggestions/{suggestionId}/reject', [$productAdmin, 'rejectLocalizationSuggestion']);
